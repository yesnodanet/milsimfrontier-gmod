...
if (SERVER and CloudAuthX and CloudAuthX.GetVersion and CloudAuthX.GetVersion() < 21) then
	for i = 1, 3 do
...
if (SERVER and CloudAuthX and CloudAuthX.Authenticate) then
	CloudAuthX.Authenticate();
end;
...
if (SERVER and CloudAuthX and CloudAuthX.Initialize) then
